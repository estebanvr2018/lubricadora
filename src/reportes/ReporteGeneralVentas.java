...
public class ReporteGeneralVentas {

	public GeneraReportes objGeneraReportes = new GeneraReportes();
	Map<String, Object> mapParametros = new HashMap<String, Object>();
	
	public void genereReporteGeneralVentas(String strFechaInicio, String strFechaFin, String strTipo, Date dtFecha) {
		...
		try {
			if (strFechaInicio != null && strFechaFin != null) {
				...
				if (strRuta != null) {
					...
					JasperReport jasper = (JasperReport) JRLoader.loadObject(getClass().getResource("/reportes/reporteCompras.jasper"));
