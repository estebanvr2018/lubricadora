...
public class clientesIU  implements EventHandler<ActionEvent> 
{
		...
		public void insertaCliente(String identificacion) 
		{
			...
			/*Date dateI = new Date();
			DateFormat dateFormatI = new SimpleDateFormat("dd/MM/yyyy");
			System.out.println("Fecha actual: "+dateFormatI.format(dateI));
			txtFechaI.setText(dateFormatI.format(dateI).toString());
			txtFechaI.setEditable(false);*/
			
			/*Label lblFechaActua = new Label("Fecha");
			lblFechaActua.setLayoutX(300);
			lblFechaActua.setLayoutY(180);
			TextField txtFechaAct = new TextField();
			txtFechaAct.setLayoutX(380);
			txtFechaAct.setLayoutY(175);
			
			Date dateU = new Date();
			DateFormat dateFormatU = new SimpleDateFormat("dd/MM/yyyy");
			System.out.println("Fecha actual: "+dateFormatU.format(dateU));
	        ...
	        root.getChildren().addAll(scenetitle, lblRuc,txtRuc,lblCliente,txtCliente,lblApellidos,txtApellidos,txtDireccion,txtTelefono,txtCorreo,lblFecha,txtFecha,txtFechaI,btnAdd,btnCancelar);
...
/*** INI modifica cliente ***/
		...
		{
			System.out.println(" dentro hijo 1");
			Text scenetitle = new Text("Datos del cliente");
			scenetitle.setFont(Font.font("Tahoma", FontWeight.NORMAL, 20));
			scenetitle.setX(180);
			scenetitle.setY(40);
	        ...
	        /**/
	        root.getChildren().addAll(bp,lblDireccion,lblTelefono,lblCorreo,lblFechaIngreso);
	        root.getChildren().addAll(scenetitle, lblRuc,txtRuc,lblCliente,txtCliente,lblApellidos,txtApellidos,txtDireccion,txtTelefono,txtCorreo,lblFecha,txtFecha,txtFechaI,btnUpdate,btnCancelar);
			Scene escenaConsulta = null;
			escenaConsulta = new Scene(root, 510, 300);
		...
		{
			//txtRuc,txtCliente,txtDireccion,txtApellidos,txtTelefono,txtCorreo; txtRuc,txtCliente,txtApellidos,txtDireccion,txtTelefono,txtCorreo;
...
/*** FIN modifica cliente ***/
	...
	public boolean verificaCampos(String strNombres, String strApellidos, String srtDireccion, String strTelefono, String strCorreo)
	{
 ...
 public void insertaClienteBD(String strId, String strNombre, String strApellidos,String strDireccion,String strTelefono,String strCorreo)
 {
	System.out.println("================================================================================");
 ...
 public void actualizaClienteBD(String strId,String strNombre, String strApellidos,String strDireccion,String strTelefono,String strCorreo)
 {
	System.out.println("================================================================================");
	...
	try 
	{	System.out.println(" 1");
		resInsert = objInsertar.actualizaCliente(strId,strNombre, strApellidos,strDireccion,strTelefono,strCorreo);
		System.out.println(" 2: "+resInsert);
		if ( resInsert == 1)
		{	
			System.out.println("Resultado del query: "+resInsert);
...
/*** ***/	
  public void handle(ActionEvent event) 
  {
	if (event.getSource() == btnAdd) 
	{
		...
		verifica = verificaCampos(txtCliente.getText().toString().trim(),txtApellidos.getText().toString().trim(),txtDireccion.getText().toString().trim(),txtTelefono.getText().toString().trim(),txtCorreo.getText().toString().trim());
		System.out.println("Verifica: "+verifica);
		if (!verifica)
		{	
			System.out.println("Entro");
			insertaClienteBD(txtRuc.getText().toString().trim(),txtCliente.getText().toString().trim(),txtApellidos.getText().toString().trim(),txtDireccion.getText().toString().trim(),txtTelefono.getText().toString().trim(),txtCorreo.getText().toString().trim());
		}
	}
	...
	else if ( event.getSource() == btnUpdate ) 
	   {
	    	...
	    	System.out.println("==================================================");
	    	actualizaClienteBD(txtRuc.getText().toString().trim(),txtCliente.getText().toString().trim(),txtApellidos.getText().toString().trim(),txtDireccion.getText().toString().trim(),txtTelefono.getText().toString().trim(),txtCorreo.getText().toString().trim());
	    	//ventanaActual.close();
