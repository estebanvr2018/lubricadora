...
public class botones {
	...
	public ImageView botonAgregarListaBig() {
		Image image = new Image("application/images/guardarGeneral.png", 25, 25, true, true);
		ImageView imgVie = new ImageView(image);
		return imgVie;
	}
	...
	public ImageView fondoPantalla() {
		Image imgCarga = new Image("application/images/fondoPrincipal.jpg",1200,1200, true , true);
	...
	public ImageView botonLimpiarPNG() {
	...
	public ImageView botonActualizaProducto() {
		Image imgCarga = new Image("application/images/actualiza_prod.png", 25, 25, true, true);
		ImageView imgView = new ImageView(imgCarga);
		return imgView;
	}

	public ImageView botonReporte() {
		Image image = new Image("application/images/excel.png", 25, 25, true, true);
		ImageView imgVie = new ImageView(image);
		return imgVie;
	}
